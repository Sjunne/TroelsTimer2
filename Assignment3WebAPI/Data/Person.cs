...
public class Person {
    ...
    {
        return $"{nameof(Id)}: {Id}, {nameof(FirstName)}: {FirstName}, {nameof(LastName)}: {LastName}, {nameof(HairColor)}: {HairColor}, {nameof(EyeColor)}: {EyeColor}, {nameof(Age)}: {Age}, {nameof(Weight)}: {Weight}, {nameof(Height)}: {Height}, {nameof(Sex)}: {Sex}";
    }
}

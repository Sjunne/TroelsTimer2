...
namespace TodoWebAPI.Data
{
    public class TodoService : ITodoService
    {
        ...
        public async Task<IList<Todo>> GetTodosAsync(bool? iscompleted, int? id)
        {
            List<Todo> tmp = new List<Todo>(todos.Where(todo =>
                (iscompleted != null && iscompleted == todo.IsCompleted || iscompleted == null)
                && (id != null && id == todo.TodoId || id == null)));
